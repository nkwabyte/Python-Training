# Module M08 — Convolutional Networks and Vision

**Level:** 05 Machine Learning, Part 9 (Deep Learning with PyTorch)  |  **Time:** L4 E7  |  **Prerequisite:** Module M07
...
5. **Architectures** — LeNet to AlexNet to VGG to ResNet. The residual connection as the single most important idea, connected back to gradient flow in Module M07.
