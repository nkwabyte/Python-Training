# Module M13 — Diffusion Models

**Level:** 05 Machine Learning, Part 10 (Generative Models)  |  **Time:** L5 E7  |  **Prerequisite:** Module M12
...
your GAN from Module M12 on sample quality, diversity, and wall-clock cost.
...
A GPU is effectively required for the full training exercise. The module ships a reduced 16 by 16 configuration that completes on CPU, and a pretrained checkpoint so the sampling and guidance exercises can be done without training.
