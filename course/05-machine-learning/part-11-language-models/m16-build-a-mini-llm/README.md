# Module M16 — Build a Mini LLM from Scratch

**Level:** 05 Machine Learning, Part 11 (Language Models and LLMs)  |  **Time:** P16  |  **Prerequisite:** Modules M11 and M15
...
- Assemble a GPT-style decoder from your Module M11 components.
...
6. **Generation** — Wiring up the sampling from Module M15, adding a KV cache, and measuring the speedup.
...
| `stage2_model.py` | Assemble the model from your M11 components and check the parameter count. |
