"""
B05 Collections: Lists, Dictionaries, Sets, and Tuples
Exercise: ex06_aliasing.py

Goal
----
Observe a shared list being changed through two names.

Run it
------
    python ex06_aliasing.py
