"""
B06 Functions: Naming a Piece of Work
Exercise: ex02_return_vs_print.py

Goal
----
Fix three functions that print when they should return.

Run it
------
    python ex02_return_vs_print.py
