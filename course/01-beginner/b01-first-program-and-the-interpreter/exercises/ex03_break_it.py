"""
B01 Your First Program and How Python Runs It
Exercise: ex03_break_it.py

Goal
----
Deliberately introduce four errors and record what each traceback said.

Run it
------
    python ex03_break_it.py
