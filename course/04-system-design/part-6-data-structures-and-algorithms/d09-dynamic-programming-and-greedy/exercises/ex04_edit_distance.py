"""
D09 Dynamic Programming and Greedy Algorithms
Exercise: ex04_edit_distance.py

Goal
----
Edit distance with the operation sequence, not just the cost.

Run it
------
    python ex04_edit_distance.py
