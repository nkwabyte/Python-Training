"""
D10 Patterns, Drills, and the Bridge to System Design
Exercise: ex04_bloom.py

Goal
----
Implement a Bloom filter and measure the false positive rate against theory.

Run it
------
    python ex04_bloom.py
