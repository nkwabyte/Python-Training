"""
D08 Recursion, Backtracking, and Divide and Conquer
Exercise: ex04_to_iterative.py

Goal
----
Convert three recursive functions to explicit stack versions.

Run it
------
    python ex04_to_iterative.py
